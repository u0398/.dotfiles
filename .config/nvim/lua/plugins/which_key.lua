...
local keymaps = {
  ...
  ["<F12>"]     = 'DAP step out',
  ["<C-\\>"]    = 'Launch  terminal',
  ["<C-h>"]     = 'Split navigate left',
  ["<C-j>"]     = 'Split navigate down',
  ["<C-k>"]     = 'Split navigate up',
  ["<C-l>"]     = 'Split navigate right',
  ["<A-h>"]     = 'Split resize left',
  ["<A-j>"]     = 'Split resize down',
  ["<A-k>"]     = 'Split resize up',
  ["<A-l>"]     = 'Split resize right',
  ["<C-p>"]     = 'Fuzzy find project files',
  ["<C-s>"]     = 'Save',
  ["<C-r>"]     = 'Redo',
  ["<C-c>"]     = 'close buffer without loosing the opened window',
  ["u"]         = 'Undo',
  ["U"]         = 'Undo line',
  ["."]         = 'Repeat last edit',
