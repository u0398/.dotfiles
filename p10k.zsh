# Generated by Powerlevel10k configuration wizard on 2021-03-29 at 14:25 PDT.
...
() {
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=45
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=81

  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%B%n${FG[015]}@${FG[007]}%m"
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE="%n${FG[015]}@${FG[007]}%m"
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%n${FG[015]}@${FG[007]}%m"
  ...
  function prompt_lcontext() {
    p10k segment -t "${FG[081]}%n${FG[015]}@${FG[007]}%m"
  }

  function prompt_returncode() {
    p10k segment -t "${FG[081]}$?"
  }
